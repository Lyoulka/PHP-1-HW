		...
		<html lang="en">
		 ...
		 <body>
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
   			 <?php if ($_SESSION['auth'] && ($_SESSION['admin'] == 0)):?>
    			...
    			<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    			    <ul class="navbar-nav mr-auto mt-2 ml-5 mt-lg-0">
                     ...
                     <li class="nav-item active">
                            <a href="user_orders.php" class="btn btn-success btn-md ml-3" role="button" aria-pressed="true">Мои заказы</a>
                     </li>
    			    </ul>
                    ...
                    <?php elseif ($_SESSION['auth'] && $_SESSION['admin'] == 1):;?>
                      <span class="navbar-brand">Здравствуй, администратор</span>
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul class="navbar-nav mr-auto mt-2 ml-5 mt-lg-0">
                        <li class="nav-item active">
                            <a href="../engine/session_destroy.php" class="btn btn-danger btn-md" role="button" aria-pressed="true">Выйти из профиля</a>
                        ...
                        <li class="nav-item active">
                            <a href="administration.php" class="btn btn-success btn-md ml-3" role="button" aria-pressed="true">Управление заказами</a>
                        </li>
                        <li class="nav-item active">
                            <a href="user_orders.php" class="btn btn-success btn-md ml-3" role="button" aria-pressed="true">Мои заказы</a>
                        </li>
